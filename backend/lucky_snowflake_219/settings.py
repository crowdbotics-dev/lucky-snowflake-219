"""
Django settings for lucky_snowflake_219 project.
...
ROOT_URLCONF = 'lucky_snowflake_219.urls'
...
WSGI_APPLICATION = 'lucky_snowflake_219.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lucky_snowflake_219 API",
    "DESCRIPTION": "API documentation for lucky_snowflake_219 App",
    "VERSION": "v1",
}
